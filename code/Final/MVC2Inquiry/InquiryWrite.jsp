...
<title>문의 사항 글쓰기</title>
<script type="text/javascript">
	function validateForm(form) { // 제목 입력 확인
		if (form.title.value == "") {
			alert("제목을 입력하세요.");
			form.title.focus();
			return false;
		}
		if (form.icontent.value == "") { // 내용 입력 확인
			alert("내용을 입력하세요.");
			form.icontent.focus();
			return false;
		}
...
<body>
	...
	<main>
		...
		<section>
			<article>
				<!-- 글쓰기 제목 및 내용 입력 -->
				<form name="writeFrm" method="post" action="../mvc2/write.do"
    				...
    				table-bordered border-dark table-hover">
						<tr>
							<td><input type="text" class="form-control"
								placeholder="제목을 입력해주세요." name="title" style="width: 90%;" /></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="내용을 입력해주세요."
									name="icontent" style="width: 90%; height: 100px;"></textarea>
							</td>
