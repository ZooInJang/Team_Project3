	...
	<article>
		...
		<article>
			...
			<div style="height: 30px; display: flex; text-align: center;">
					...
					<!-- 전체 회의실 평점 비율(원 그래프)과 101호 평점 ★로 그리기 -->
					...
					<!-- 101호의 각 평점(5,4,3,2,1) 갯수 출력(막대 그래프) -->
		...
		<article>
			...
			<!-- 전체 회의실 평점 비율(원 그래프)과 102호 평점 ★로 그리기 -->
			<div style="height: 30px; display: flex; text-align: center;">
				...
				<script>
					...
					<!-- 102호의 각 평점(5,4,3,2,1) 갯수 출력(막대 그래프) -->
					<div style="width: 1000px; margin-left: 50px;">
						<canvas id="myChart1"></canvas>
					</div>		
					<script>
		...
		<article>
			...
			<!-- 전체 회의실 평점 비율(원 그래프)과 103호 평점 ★로 그리기 -->
			<div style="height: 30px; display: flex; text-align: center;">
				<div style="width: 800px; margin-left: 50px">
					<canvas id="myChart" style="margin-bottom: 40px;"></canvas>
					<p>평균 평점(5점만점)</p>
				...
				<script>
					...
					<!-- 103호의 각 평점(5,4,3,2,1) 갯수 출력(막대 그래프) -->
					<div style="width: 1000px; margin-left: 50px;">
						<canvas id="myChart1"></canvas>
					</div>		
					<script>
