...
<!-- 헤더 -->
	<header class="headerBox">
		...
		<!-- 이 아래는 좌측 상단 아이콘에 마우스를 가져다 대면 나타나는 서브메뉴입니다. -->
				...
				<ul class="row">
					<li class="name">회사소개
						<ul class="innerMenu">
							...
							<li><a href="<%=request.getContextPath()%>/op.do">방침 및
									목표</a></li>
							<li><a href="<%=request.getContextPath()%>/howtocome.do">오시는길</a></li>
						</ul>
					</li>
					<li class="name">회의실 예약
						<ul class="innerMenu">
							<li><a
								href="<%=request.getContextPath()%>/mvc2/review.do?room=101">101호</a></li>
							<li><a
								href="<%=request.getContextPath()%>/mvc2/review.do?room=102">102호</a></li>
							<li><a
								href="<%=request.getContextPath()%>/mvc2/review.do?room=103">103호</a></li>
						</ul>
					</li>
		...
		<!-- 메인 메뉴(MUF) 입니다. -->
		<div class="MUF-logo">
			<a href="<%=request.getContextPath()%>/mvc2/index.do"
				class="sitename">MUF</a>
		</div>
		
		<!-- 우측 상단 메인 메뉴에 나타나는 로그인,회원가입등의 메뉴입니다. -->
		<div class="menu">
			<ul>
